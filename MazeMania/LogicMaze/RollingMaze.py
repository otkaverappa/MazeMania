...
class RollingMazeSearchState( SearchState ):
	def __init__( self, cell, previousMove=None, previousState=None ):
		SearchState.__init__( self, cell=cell, previousMove=previousMove, previousState=previousState )

class RollingMazeConfig:
	def __init__( self, rows, cols, rollingMaze, startCellNumber, targetCellNumber ):
